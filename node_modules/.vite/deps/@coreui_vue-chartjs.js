...
// node_modules/.pnpm/@coreui+vue-chartjs@3.0.0_@popperjs+core@2.11.8_vue@3.5.13/node_modules/@coreui/vue-chartjs/dist/esm/index.js
function round(v) {
  return v + 0.5 | 0;
}
...
function merge$2(target, source, options) {
  const sources = isArray$a(source) ? source : [
    source
  ];
...
function _longestText(ctx, font, arrayOfThings, cache) {
  ...
  for (i = 0; i < ilen; i++) {
    ...
    if (thing !== void 0 && thing !== null && !isArray$a(thing)) {
...
function renderText(ctx, text, x, y, font, opts = {}) {
  const lines = isArray$a(text) ? text : [
    text
  ];
...
var Animations = class {
  ...
  configure(config) {
    ...
    Object.getOwnPropertyNames(config).forEach((key) => {
      ...
      (isArray$a(cfg.properties) && cfg.properties || [
        key
      ]).forEach((prop) => {
...
var hasFunction = (value) => isObject$a(value) && Object.getOwnPropertyNames(value).some((key) => isFunction$4(value[key]));
...
var Chart = class {
  ...
  _updateDatasets(mode) {
    ...
    for (let i = 0, ilen = this.data.datasets.length; i < ilen; ++i) {
      this._updateDataset(i, isFunction$4(mode) ? mode({
        datasetIndex: i
      }) : mode);
    }
...
var Tooltip = class extends Element {
  ...
  _drawColorBox(ctx, pt, i, rtlHelper, options) {
    ...
    if (options.usePointStyle) {
      ...
      ctx.lineWidth = isObject$a(labelColor.borderWidth) ? Math.max(...Object.values(labelColor.borderWidth)) : labelColor.borderWidth || 1;
      ctx.strokeStyle = labelColor.borderColor;
...
var CChart = defineComponent({
  ...
  setup(props, { expose, emit, slots }) {
    ...
    const computedData = computed(() => typeof props.data === "function" ? canvasRef.value ? props.data(canvasRef.value) : { datasets: [] } : merge$1({}, props.data));
    const computedOptions = computed(() => props.customTooltips ? merge$1({}, props.options, {
      plugins: {
        tooltip: {
          enabled: false,
          mode: "index",
    ...
    const handleOnClick = (e) => {
      if (!chartRef.value)
        return;
      emit("getDatasetAtEvent", chartRef.value.getElementsAtEventForMode(e, "dataset", { intersect: true }, false), e);
      emit("getElementAtEvent", chartRef.value.getElementsAtEventForMode(e, "nearest", { intersect: true }, false), e);
      emit("getElementsAtEvent", chartRef.value.getElementsAtEventForMode(e, "index", { intersect: true }, false), e);
    };
    const updateChart = () => {
      if (!chartRef.value)
        return;
      ...
      assign$1(chartRef.value.config.data, newChartData);
      chartRef.value.config.data.datasets = newDataSets.map((newDataSet) => {
        const currentDataSet = find$1(currentDataSets, (d) => d.label === newDataSet.label && d.type === newDataSet.type);
...
var CChartBubble = defineComponent({
  name: "CChartBubble",
  extends: CChart,
  setup(props) {
...
var CChartDoughnut = defineComponent({
  name: "CChartDoughnut",
  extends: CChart,
  setup(props) {
...
var CChartLine = defineComponent({
  name: "CChartLine",
  extends: CChart,
  setup(props) {
...
var CChartPolarArea = defineComponent({
...
var CChartRadar = defineComponent({
  name: "CChartRadar",
  extends: CChart,
  setup(props) {
...
var CChartScatter = defineComponent({
  name: "CChartScatter",
  extends: CChart,
  setup(props) {
...
@coreui/vue-chartjs/dist/esm/index.js:
  ...
  (*!
    ...
    *)
*/
//# sourceMappingURL=@coreui_vue-chartjs.js.map
