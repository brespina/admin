  ...
  >
    <div class="row d-flex align-items-center p-3 px-xl-4 flex-xl-nowrap">
      ...
      <div class="col-md col-12 px-lg-4">
        ...
        <strong>
          the only open-source Vue dashboard built on a professional,
          enterprise-grade UI Components Library
        </strong>
        . This component is part of this library, and we present only the basic
        usage of it here. To explore extended examples, detailed API
